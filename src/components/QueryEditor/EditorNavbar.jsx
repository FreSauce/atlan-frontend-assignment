    ...
    <div className="flex text-sm font-medium text-center  text-gray-500 border-b border-gray-200 dark:text-gray-400 dark:border-gray-700">
      ...
      <div className="flex items-center justify-center justify-self-end min-w-fit gap-2 px-3 py-2">
        <Button
          ...
          focus:ring-green-300 dark:focus:ring-green-800 disabled:bg-green-900 disabled:hover:bg-green-900 dark:disabled:bg-green-900 dark:disabled:hover:bg-green-900"
        />
        <Button
          onClick={saveQuery}
          disabled={!activeTab}
          ...
          focus:ring-blue-300 dark:focus:ring-blue-800 disabled:bg-blue-900 disabled:hover:bg-blue-900 dark:disabled:bg-blue-900 dark:disabled:hover:bg-blue-900"
        />
      </div>
    </div>
  );
